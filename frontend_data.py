india_states_districts = {
    ...
    "Andhra Pradesh": ["Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool", "Nellore", "Prakasam", "Srikakulam", "Visakhapatnam", "Vizianagaram", "West Godavari", "YSR Kadapa", "Anakapalli", "Kakinada", "Konaseema", "NTR", "Palnadu", "Parvathipuram Manyam", "Sathya Sai", "Tirupati", "Alluri Sitarama Raju", "Eluru", "Krishna", "Nandyal", "Srikakulam", "Vizianagaram", "West Godavari"],
    ...
    "Mizoram": ["Aizawl", "Champhai", "Kolasib", "Lawngtlai", "Lunglei", "Mamit", "Saiha", "Serchhip", "Siaha", "West Phaileng"],
    ...
    "Uttar Pradesh": ["Agra", "Aligarh", "Allahabad", "Ambedkar Nagar", "Amethi", "Amroha", "Auraiya", "Azamgarh", "Baghpat", "Bahraich", "Ballia", "Balrampur", "Banda", "Barabanki", "Bareilly", "Basti", "Bhadohi", "Bijnor", "Budaun", "Bulandshahr", "Chandauli", "Chitrakoot", "Deoria", "Etah", "Etawah", "Faizabad", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddha Nagar", "Ghaziabad", "Ghazipur", "Gonda", "Gorakhpur", "Hamirpur", "Hardoi", "Hathras", "Jalaun", "Jaunpur", "Jhansi", "Kannauj", "Kanpur Dehat", "Kanpur Nagar", "Kasganj", "Kaushambi", "Kheri", "Kushinagar", "Lalitpur", "Lucknow", "Maharajganj", "Mahoba", "Mainpuri", "Mathura", "Mau", "Meerut", "Mirzapur", "Moradabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", "Raebareli", "Rampur", "Saharanpur", "Sambhal", "Sant Kabir Nagar", "Shahjahanpur", "Shamli", "Shravasti", "Siddharthnagar", "Sitapur", "Sonbhadra", "Sultanpur", "Unnao", "Varanasi"],
...
seasons = {'Autumn': ['september', 'october'], 'Summer': ['march', 'april', 'may', 'june'], 'Winter': ['november', 'december', 'january', 'february'], 'Kharif': ['june', 'july', 'august', 'september', 'october'], 'Rabi': ['november', 'december', 'january', 'february', 'march', 'april'], 'Whole Year': ['january', 'february', 'march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december']}

crops = ['Arecanut', 'Arhar/Tur', 'Bajra', 'Black pepper', 'Cashewnut',
       'Castor seed', 'Coriander', 'Cotton(lint)', 'Cowpea(Lobia)',
       'Dry chillies', 'Garlic', 'Ginger', 'Gram', 'Groundnut',
       'Horse-gram', 'Jowar', 'Linseed', 'Masoor', 'Mesta',
       'Moong(Green Gram)', 'Niger seed', 'Onion', 'Other  Rabi pulses',
       'Other Kharif pulses', 'other oilseeds', 'Potato', 'Ragi',
       'Rapeseed &Mustard', 'Safflower', 'Sesamum', 'Small millets',
       'Soyabean', 'Sunflower', 'Sweet potato', 'Tapioca', 'Tobacco',
       'Urad', 'Wheat', 'Maize', 'Peas & beans (Pulses)', 'Rice',
       'Barley', 'Jute', 'Khesari', 'Sannhamp', 'Sugarcane', 'Turmeric',
...
for state in india_states_districts.keys():
    state_tuple = (state, state);
    state_tuples.append(state_tuple);

def find_district_tuples(state):
    district_tuples = []

    for district in india_states_districts[state]:
        district_tuple = (district, district)
        district_tuples.append(district_tuple)
